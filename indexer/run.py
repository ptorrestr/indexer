...
paramFields = [
  ...
  {"name":"file_path","kind":"mandatory","type":str,"default":None,"abbr":"--file","help":"Bzip2 file"},
...
def runIndexer():
  ...
  # Read input
  description = 'Indexing bzip2 files on ElasticSearch'
  epilog = ''
...
def indexer(config, param):
  ...
  n = index_bzip2_file(param.file_path, es, index_header, param.buffer_size)
